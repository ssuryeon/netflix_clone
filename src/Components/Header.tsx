...
const Circle = styled(motion.span)`
    ...
    left: 0;
    right: 0;
    margin: 0 auto; // left: 0, right: 0, margin: 0 auto; 로 해두면 가로 중앙정렬 됨
...
const logoVars = {
    ...
    hover: {
        fillOpacity: [0,1,0], // 배열로 입력하면 배열의 순서대로 바뀜
        transition: {
    ...
    return (
        <Nav variants={navVars} animate={navAnimation} initial={'top'}>
            ...
            <Logo
                ...
                variants={logoVars}
                initial='normal' // initial이 있어야 hover 안했을때 원상태로 돌아감
                whileHover='hover'
            >
                ...
                <Items>
                    <Item><Link to='/'>Home {(homeMatch?.isExact || bigMovieMatch) && <Circle layoutId="circle"/>}</Link></Item>
                    <Item><Link to='/tv'>Tv shows {tvMatch && <Circle layoutId="circle"/>}</Link></Item>
                </Items>
            </Col>
            <Col>
                <Search>
